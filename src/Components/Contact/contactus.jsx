      ...
      <div className="relative w-full lg:max-w-7xl lg:mx-auto overflow-hidden">
        <section className="bg-white px-6 md:px-10 lg:px-20 py-15 font-Poppins">
          ...
          <div className="text-center max-w-5xl mx-auto">
            ...
            {/* Mobile 3 lines */}
            <h1 className="text-[36px] md:text-[62px] font-bold text-black 
          ...
          <div className="mt-4">
            ...
            <div className="flex flex-col lg:flex-row lg:justify-end gap-3 lg:gap-25">
              ...
              <div className="w-full max-w-[320px] self-start md:self-start lg:self-auto">
                ...
                <div className="mb-6">
                  <select className="w-full bg-transparent font-medium text-[20px] border-b-2 border-gray-400 text-black focus:outline-none py-2">
