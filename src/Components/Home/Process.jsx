      ...
      <div className="max-w-7xl mx-auto">
        ...
        <div className="grid grid-cols-1 md:grid-cols-1 lg:grid-cols-2 gap-10 md:gap-16 lg:gap-20 items-start">
          ...
          <div className="space-y-5 md:space-y-6">
              ...
              <div key={index}>
                ...
                <div className="flex justify-between items-start gap-4">
                  ...
                  <div>
                    ...
                    <p className="text-[#7A7A7A] text-xs md:text-sm leading-tight mt-1 max-w-full md:max-w-2xl">
                      {step.desc}
                    </p>
                  </div>
            ...
            {/* Button */}
            <button className="mt-6 bg-[#1E3A8A] text-white px-5 md:px-6 py-2.5 md:py-3 flex items-center gap-2 hover:bg-[#1e40af] transition text-sm md:text-base">
              Connect with
              <span>→</span>
            </button>
          </div>
